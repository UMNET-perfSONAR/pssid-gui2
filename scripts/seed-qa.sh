...
echo "when QA needs it. Verify with Settings > Configuration > Preview (and use"
echo "Generate there to write pssid_config.json for the daemon --validate check),"
echo "and per host with the 'Probe configuration' panel on the Hosts page."
echo ""
